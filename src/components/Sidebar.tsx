...
export default function Sidebar({ history, selectedId, onSelect, onDelete, onClearAll, onRename, onAbout }: SidebarProps) {
  ...
  return (
    <div className="w-64 flex-shrink-0 bg-bg-panel border-r border-border-subtle flex flex-col">
      ...
      <div className="px-3 py-2.5 border-t border-border-subtle flex items-center gap-1">
        <button
          onClick={onAbout}
          className="p-1.5 rounded text-text-quaternary hover:text-text-secondary hover:bg-white/[0.04] transition-colors"
          title="关于"
        >
